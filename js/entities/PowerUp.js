...
export class LifePowerUp extends PowerUp {
    ...
    activate(game) {
        ...
        if (game.lives < 3) {
            ...
            console.log('Already at max lives (3)');
        }
        super.activate(game);
    }
}
...
export class AutoFirePowerUp extends PowerUp {
    ...
    activate(game) {
        ...
        console.log('Auto-fire activated for 4 seconds!');
        super.activate(game);
    }
}
...
export class TripleShotPowerUp extends PowerUp {
    ...
    activate(game) {
        ...
        console.log('Triple shot activated for 5 seconds!');
        super.activate(game);
    }
}
...
export class RocketPowerUp extends PowerUp {
    ...
    activate(game) {
        ...
        game.rocketAmmo += 1;
        console.log('Rocket ammo +1! Total: ' + game.rocketAmmo);
        super.activate(game);
    }
}
